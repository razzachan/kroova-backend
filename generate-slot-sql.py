#!/usr/bin/env python3
"""
Aplicar Sistema de Slots - Versão Simplificada
Gera arquivo SQL único para executar manualmente
"""

print("""
================================================================================
  GERADOR DE SQL PARA SISTEMA DE SLOTS
================================================================================

Este script vai gerar um arquivo SQL completo que você pode:
1. Copiar e colar no SQL Editor do Supabase Dashboard
2. Executar de uma vez só
...
-- Gerado automaticamente em """ + str(__import__('datetime').datetime.now()) + """
-- ============================================================================
...
# Salvar arquivo
with open('SLOT_SYSTEM_EXECUTE.sql', 'w', encoding='utf-8') as f:
    f.write(sql_content)

print("""
✅ Arquivo gerado com sucesso!

📁 Arquivo: SLOT_SYSTEM_EXECUTE.sql
...
4. Copie TODO o conteúdo de SLOT_SYSTEM_EXECUTE.sql

5. Cole no editor e clique em "Run"

6. Verifique os resultados na última query

Resultado esperado:
==================
- Básico: 5 slots configurados
- Padrão: 5 slots configurados
- Premium: 5 slots configurados
- Elite: 6 slots configurados
- Whale: 7 slots configurados

================================================================================
✅ Sistema pronto para ser aplicado!
================================================================================
""")
